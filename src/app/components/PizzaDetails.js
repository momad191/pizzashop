      ...
      <div className="flex flex-col flex-1">
        <div className="flex-1 p-x text-center lg:text-left">
          <div className="flex-1 bg-white overflow-y-scroll h-[44vh] lg:h-[64vh] scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-white pr-2">
            ...
            <div className="mb-4 text-xl font-semibold font-Kufi-arabic ">
              اختر الطبقة العلوية
            </div>

            {/* toppings List */}
            <div className="flex flex-1 flex-wrap gap-2 py-1 justify-center lg:justify-start font-Kufi-arabic">
